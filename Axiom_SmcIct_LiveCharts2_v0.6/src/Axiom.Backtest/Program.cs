...
Console.WriteLine($"Econ: spread_ticks={spreadTicks:g} spread_bps={spreadBps:g} slip_ticks={slipTicks:g} slip_bps={slipBps:g} comm_bps={commBps:g} comm_fixed={commFixed:g} qty={qty:g}");
