...
## v0.7
- Optional killzone gating: `RestrictToKillzones=true` + `KillzonePreset=ICT_KZ_UTC`
- TP pools can include zone midpoints: `UseZoneMidPools=true`
- Backtest economics can be ATR-aware: `--econo_mode Atr --atr_spread_frac 0.02 --atr_slip_frac 0.01`
- Backtest writes `equity_curve.csv`
