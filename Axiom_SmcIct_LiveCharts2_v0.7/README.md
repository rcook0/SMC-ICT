# Axiom.SmcIct — .NET solution skeleton (LiveCharts2) v0.7

v0.7 focuses on **broker-grade economics**, **determinism / no-lookahead**, and **extensible TP pool modules**.
...
## v0.7 additions
- Killzone gating (optional): restrict signals to London/NY kill zones (UTC preset)
- TP pool module: zone midpoints (OB/FVG/Breaker mids)
- Economics: ATR-aware spread/slippage mode (optional)
- Backtest: equity curve + drawdown report, plus optional parameter sweep runner
